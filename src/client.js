...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const PROVIDER_ICONS = {
      ...
      antigravity:
        '<svg fill="currentColor" fill-rule="evenodd" height="1em" style="flex:none;line-height:1" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><title>Antigravity</title><path d="M21.751 22.607c1.34 1.005 3.35.335 1.508-1.508C17.73 15.74 18.904 1 12.037 1 5.17 1 6.342 15.74.815 21.1c-2.01 2.009.167 2.511 1.507 1.506 5.192-3.517 4.857-9.714 9.715-9.714 4.857 0 4.522 6.197 9.714 9.715z"></path></svg>',
      gemini:
        '<svg fill="currentColor" fill-rule="evenodd" height="1em" style="flex:none;line-height:1" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg"><title>Gemini</title><path d="M12 0C12 6.627 6.627 12 0 12c6.627 0 12 5.373 12 12 0-6.627 5.373-12 12-12-6.627 0-12-5.373-12-12z"></path></svg>',
    }
    /** currentColor 图标的着色；kimi 图标自带品牌底色，走 null 不上色。 */
    const PROVIDER_ICON_COLOR = { codex: '#10a37f', xai: 'var(--dsw-alias-label-primary)', claude: '#d97757', kimi: null, antigravity: '#1a73e8', gemini: '#4285f4' }
    const providerColor = (p) =>
      ({ codex: '#10a37f', kimi: '#7c5cff', xai: '#e5484d', claude: '#d97757', gemini: '#4285f4', antigravity: '#1a73e8' })[p] ?? T.brand
